...
$cache_enabler_fork_build   = '1';        // Increment for each fork release

$cache_enabler_constants = array(
    'CACHE_ENABLER_BASE_VERSION'   => $cache_enabler_base_version,
    'CACHE_ENABLER_FORK_BUILD'      => $cache_enabler_fork_build,
    'CACHE_ENABLER_VERSION'         => $cache_enabler_base_version . '-fork.' . $cache_enabler_fork_build . '-beta',
